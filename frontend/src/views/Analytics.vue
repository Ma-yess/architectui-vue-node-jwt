    ...
    <div>
        ...
        <div class="mb-3 card">
            ...
            <div class="text-center d-block p-3 card-footer">
                <button class="btn-pill btn-shadow btn-wide fsize-1 btn btn-primary btn-lg " @click.prevent="logOut">
...
<script>
    ...
    import PageTitle from "../Layout/Components/PageTitle" ;//"../../Layout/Components/PageTitle.vue";
    import VuePerfectScrollbar from 'vue-perfect-scrollbar'

    import chart1 from "../DemoPages/Dashboards/Analytics/chart1" //'./Analytics/chart1';
